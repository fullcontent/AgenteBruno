...
ROOT_FILES=(README.md USER.md GOALS.md DECISION_RULES.md THINKING.md WORKFLOW.md WRITING_STYLE.md PROJECTS.md NOW.md IDEAS.md HERMES.md)
FOLDERS=(projects knowledge templates skills archive logs)
